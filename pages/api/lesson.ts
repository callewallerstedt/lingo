      ...
      content: [
        {
          ...
          text: [
            ...
            "## Quick practice — exactly 4 short prompts. Put each prompt on its own numbered line, immediately followed by one line beginning exactly `Answer:`. Do not reveal an answer anywhere else; the app turns every `Answer:` line into a closed Show answer control.",
